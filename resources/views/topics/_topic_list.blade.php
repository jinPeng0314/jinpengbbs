            ...
            <li class="media">
                <div class="media-left">
                    <a href="{{ route('users.show', [$topic->user_id]) }}">
                        <img class="media-object img-thumbnail" style="width: 52px; height: 52px;" src="{{ isset($topic->user->avatar) ? $topic->user->avatar : '/images/default.png' }}" title="{{ $topic->user->name }}">
                    </a>
                </div>
